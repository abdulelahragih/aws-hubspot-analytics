"""
Source: https://github.com/aws-samples/amazon-quicksight-assets-as-code-sample/blob/main/src/quicksight_assets_class.py
"""
...
class Sheet():
    ...
    def add_freeform_layout_element(self, element, height, width, x_axis_location, y_axis_location, background_style={},
                                    border_style={}, loading_animation={}, rendering_rules={}, selected_border_style={},
                                    visibility=""):
...
class CategoryFilter(Filter):
    ...
    def add_custom_filter_configuration(self, match_operator, null_option, category_value="", parameter_name="",
                                        select_all_options=""):
        self.configuration = {
    ...
    def add_custom_filter_list_configuration(self, match_operator, null_option, category_values=[],
                                             select_all_options=""):
        self.configuration = {
...
class Visual():
    ...
    def add_date_dimension_field(self, column_name, data_set_identifier, date_granularity="", date_time_format="",
                                 null_string=""):
        self.category.append(
            {
                "DateDimensionField": {
    ...
    def add_numerical_measure_field(self, column_name, data_set_identifier, aggregation_function=None,
                                    currency_decimal_places='', currency_number_scale='', currency_prefix='',
    ...
    def add_filter_action(self, custom_action_id, action_name, trigger, status="ENABLED", selected_field_options="",
                          selected_fields=[], target_visual_options=[], target_visuals=[]):
        self.actions.append({
            "ActionOperations": [
                {
                    "FilterOperation": {
...
class TableVisual(Visual):
    ...
    def add_icon_conditional_formatting(self, field_id, expression, icon="", unicode_icon="", color="",
                                        icon_display_option=""):
...
class TreeMapVisual(Visual):
    ...
    def add_group_date_dimension_field(self, column_name, data_set_identifier, date_granularity="", date_time_format="",
                                       null_string=""):
        self.groups.append(
            {
                "DateDimensionField": {
    ...
    def add_color_date_dimension_field(self, column_name, data_set_identifier, aggregation_function="",
                                       date_time_format="", null_string=""):
        self.colors.append(
            {
                "DateDimensionField": {
                    "FieldId": column_name,
    ...
    def add_size_date_dimension_field(self, column_name, data_set_identifier, aggregation_function="",
                                      date_time_format="", null_string=""):
        self.sizes.append(
            {
                "DateDimensionField": {
...
class WaterfallVisual(Visual):
    ...
    def add_breakdown_date_dimension_field(self, column_name, data_set_identifier, date_granularity="",
                                           date_time_format="", null_string=""):
        self.breakdowns.append(
            {
                "DateDimensionField": {
...
class HeatMapVisual(Visual):
    ...
    def add_column_date_dimension_field(self, column_name, data_set_identifier, aggregation_function="",
                                        date_time_format="", null_string=""):
        self.columns.append(
            {
                "DateDimensionField": {
    ...
    def add_row_date_dimension_field(self, column_name, data_set_identifier, aggregation_function="",
                                     date_time_format="", null_string=""):
        self.rows.append(
            {
                "DateDimensionField": {
...
class GaugeChartVisual(Visual):
    ...
    def add_target_value_numerical_measure_field(self, column_name, data_set_identifier, aggregation_function=None,
                                                 currency_decimal_places='', currency_number_scale='',
                                                 currency_prefix='', currency_suffix='', currency_symbol='',
                                                 percentage_suffix=''):
        self.target_values.append(
            {
                "NumericalMeasureField": {
...
def clean_dict(input):
    if type(input) is dict:
        return dict((key, clean_dict(value)) for key, value in input.items() if
                    (value or value == 0) and clean_dict(value) not in [{}, [], ""])
